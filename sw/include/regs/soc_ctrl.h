...
#define CARFIELD_SPW_CLK_DIVIDER_ENABLE_REG_OFFSET 0xfc
#define CARFIELD_SPW_CLK_DIVIDER_ENABLE_SPW_CLK_DIVIDER_ENABLE_BIT 0

// SpaceWire Clock division value
#define CARFIELD_SPW_CLK_DIVISION_VALUE_REG_OFFSET 0x100
#define CARFIELD_SPW_CLK_DIVISION_VALUE_SPW_CLK_DIVISION_VALUE_MASK 0x3f
#define CARFIELD_SPW_CLK_DIVISION_VALUE_SPW_CLK_DIVISION_VALUE_OFFSET 0
#define CARFIELD_SPW_CLK_DIVISION_VALUE_SPW_CLK_DIVISION_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_SPW_CLK_DIVISION_VALUE_SPW_CLK_DIVISION_VALUE_MASK, .index = CARFIELD_SPW_CLK_DIVISION_VALUE_SPW_CLK_DIVISION_VALUE_OFFSET })

// SpaceWire Clock division value valid
#define CARFIELD_SPW_CLK_DIVISION_VALID_REG_OFFSET 0x104
#define CARFIELD_SPW_CLK_DIVISION_VALID_SPW_CLK_DIVISION_VALID_BIT 0

// SpaceWire Clock division value ready
#define CARFIELD_SPW_CLK_DIVISION_READY_REG_OFFSET 0x108
#define CARFIELD_SPW_CLK_DIVISION_READY_SPW_CLK_DIVISION_READY_BIT 0

// SpaceWire Isolate
#define CARFIELD_SPW_ISOLATE_REG_OFFSET 0x10c
#define CARFIELD_SPW_ISOLATE_SPW_ISOLATE_BIT 0

// SpaceWire Irq collector
#define CARFIELD_SPW_IRQ_REG_OFFSET 0x110
#define CARFIELD_SPW_IRQ_SPW_IRQ_BIT 0
