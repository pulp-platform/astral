...
#define CARFIELD_VERSION5_REG_OFFSET 0x14
...
#define CARFIELD_ETHERNET_RST_REG_OFFSET 0x40
#define CARFIELD_ETHERNET_RST_ETHERNET_RST_BIT 0
...
#define CARFIELD_SAFETY_ISLAND_CLK_SEL_REG_OFFSET 0x9c
...
#define CARFIELD_SECURITY_ISLAND_CLK_SEL_REG_OFFSET 0xa0
...
#define CARFIELD_PULP_CLUSTER_CLK_SEL_REG_OFFSET 0xa4
...
#define CARFIELD_SPATZ_CLUSTER_CLK_SEL_REG_OFFSET 0xa8
...
#define CARFIELD_ETHERNET_CLK_SEL_REG_OFFSET 0xac
#define CARFIELD_ETHERNET_CLK_SEL_ETHERNET_CLK_SEL_MASK 0x3
#define CARFIELD_ETHERNET_CLK_SEL_ETHERNET_CLK_SEL_OFFSET 0
#define CARFIELD_ETHERNET_CLK_SEL_ETHERNET_CLK_SEL_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_ETHERNET_CLK_SEL_ETHERNET_CLK_SEL_MASK, .index = CARFIELD_ETHERNET_CLK_SEL_ETHERNET_CLK_SEL_OFFSET })

// L2 Memory pll select (0 -> host pll, 1 -> alt PLL, 2 -> per pll)
#define CARFIELD_L2_CLK_SEL_REG_OFFSET 0xb0
...
#define CARFIELD_PERIPH_CLK_DIV_VALUE_REG_OFFSET 0xb4
...
#define CARFIELD_SAFETY_ISLAND_CLK_DIV_VALUE_REG_OFFSET 0xb8
...
#define CARFIELD_SECURITY_ISLAND_CLK_DIV_VALUE_REG_OFFSET 0xbc
...
#define CARFIELD_PULP_CLUSTER_CLK_DIV_VALUE_REG_OFFSET 0xc0
...
#define CARFIELD_SPATZ_CLUSTER_CLK_DIV_VALUE_REG_OFFSET 0xc4
...
#define CARFIELD_ETHERNET_CLK_DIV_VALUE_REG_OFFSET 0xc8
#define CARFIELD_ETHERNET_CLK_DIV_VALUE_ETHERNET_CLK_DIV_VALUE_MASK 0xffffff
#define CARFIELD_ETHERNET_CLK_DIV_VALUE_ETHERNET_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_ETHERNET_CLK_DIV_VALUE_ETHERNET_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_ETHERNET_CLK_DIV_VALUE_ETHERNET_CLK_DIV_VALUE_MASK, .index = CARFIELD_ETHERNET_CLK_DIV_VALUE_ETHERNET_CLK_DIV_VALUE_OFFSET })

// L2 Memory clk divider value
#define CARFIELD_L2_CLK_DIV_VALUE_REG_OFFSET 0xcc
...
// Host boot address
#define CARFIELD_HOST_BOOT_ADDR_REG_OFFSET 0xe8

// Safety Island boot address
#define CARFIELD_SAFETY_ISLAND_BOOT_ADDR_REG_OFFSET 0xec

// Security Island boot address
#define CARFIELD_SECURITY_ISLAND_BOOT_ADDR_REG_OFFSET 0xf0

// PULP Cluster boot address
#define CARFIELD_PULP_CLUSTER_BOOT_ADDR_REG_OFFSET 0xf4

// Spatz Cluster boot address
#define CARFIELD_SPATZ_CLUSTER_BOOT_ADDR_REG_OFFSET 0xf8

// PULP Cluster boot enable
#define CARFIELD_PULP_CLUSTER_BOOT_ENABLE_REG_OFFSET 0xfc
#define CARFIELD_PULP_CLUSTER_BOOT_ENABLE_PULP_CLUSTER_BOOT_ENABLE_BIT 0

// Spatz Cluster busy
#define CARFIELD_SPATZ_CLUSTER_BUSY_REG_OFFSET 0x100
#define CARFIELD_SPATZ_CLUSTER_BUSY_SPATZ_CLUSTER_BUSY_BIT 0

// PULP Cluster busy
#define CARFIELD_PULP_CLUSTER_BUSY_REG_OFFSET 0x104
#define CARFIELD_PULP_CLUSTER_BUSY_PULP_CLUSTER_BUSY_BIT 0

// PULP Cluster end of computation
#define CARFIELD_PULP_CLUSTER_EOC_REG_OFFSET 0x108
#define CARFIELD_PULP_CLUSTER_EOC_PULP_CLUSTER_EOC_BIT 0

// Ethernet RGMII PHY clock divider enable bit
#define CARFIELD_ETH_RGMII_PHY_CLK_DIV_EN_REG_OFFSET 0x10c
#define CARFIELD_ETH_RGMII_PHY_CLK_DIV_EN_ETH_RGMII_PHY_CLK_DIV_EN_BIT 0

// Ethernet RGMII PHY clock divider value
#define CARFIELD_ETH_RGMII_PHY_CLK_DIV_VALUE_REG_OFFSET 0x110
