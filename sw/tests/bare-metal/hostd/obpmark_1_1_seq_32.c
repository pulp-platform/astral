...
// Bare-metal SEQUENZIALE per Astral (1x CVA6, RV64) - VERSIONE 32x32
//
// Identica nella struttura e nel reporting alla versione 128x128 sequenziale
// gia' testata (stesso schema cicli/ms/throughput), solo IMG_W/IMG_H diversi
// e target L2 invece di DRAM (32x32 entra comodamente in L2).
// Serve come riferimento di correttezza per confrontare Output[0][0] con
// la versione SMP a 2 hart sulla stessa identica dimensione.
...
// ============================================================
// Generazione dati sintetici (stesso seed delle versioni SMP)
// ============================================================
...
// ============================================================
// KERNEL FUNCTIONS (sequenziali, su tutta la larghezza)
// ============================================================
...
static void print_results(uint64_t cycles) {
    ...
    printf("Benchmark metrics (sequenziale, 1x CVA6):\r\n");
...
int main(void) {
    ...
    printf("Bare-metal sequenziale - Astral CVA6 RV64 @ 50 MHz\r\n");
