...
module carfield_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[59] = (reg_addr == CARFIELD_HYPERBUS_CLK_DIV_EN_OFFSET);
    addr_hit[60] = (reg_addr == CARFIELD_HYPERBUS_CLK_DIV_VALUE_OFFSET);
  end
  ...
  assign hyperbus_clk_div_en_we = addr_hit[59] & reg_we & !reg_error;
  assign hyperbus_clk_div_en_wd = reg_wdata[0];

  assign hyperbus_clk_div_value_we = addr_hit[60] & reg_we & !reg_error;
